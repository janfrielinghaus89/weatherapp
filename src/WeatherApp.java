...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName){
        ...
        try{
            ...
            // to get the current hour's date
            // the index of the current hour is needed
            ...
            // build the weather json data object to access in the frontend
    ...
    // retrieve geographic coordinated for given location name
    public static JSONArray getLocationData(String locatioName){
        ...
        String urlString = "https://geocoding-api.open-meteo.com/v1/search?name=" +
                locatioName +  "&count=10&language=en&format=json";
        ...
        try{
            ...
            if(conn.getResponseCode() != 200){
                ...
                // read and store the resulting data into the string builder
                while(scanner.hasNext()){
                    resultJson.append(scanner.nextLine());
                }
    ...
    private static int findIndexOfCurrentTime(JSONArray timeList){
        ...
        // iterate through the time list and see which one matches the current user time
    ...
    // convert the weathercode to something more readable
